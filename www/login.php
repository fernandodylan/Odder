...
<!-- ***************************** PHP CODE AHEAD ************************* -->
						...
						<?php
							# *** Enables error reporting, so we can see what PHP thinks mistakes are
								error_reporting( E_ALL );
								ini_set( "display_errors", 1 );


							# *** Login Interface Begins
							echo '
								...
								<div class = loginTextBox>
									<center>
										<form method="post" action="">
											Username: <input type="text" name="user_name" id="usernameLogin" />
											<br><br>
...
<?php
					//$mysqli = new mysqli = new mysqli("localhost", "root", "", "odderdatabase", "odd")

/*
					try {
					$db = new PDO ("mysql:host=localhost;dbname=odderdatabase, root, "");
